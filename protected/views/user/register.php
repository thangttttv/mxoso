...
<div class="bg_white shadow m-t-10">
    ...
    <div class="SM">
        ...
        <div class="searchSM">
            <input id="password" type="password" placeholder="Mật Khẩu" size="5" maxlength="100" class="boxsearchSM"/>
        </div>
        </br>
        <div class="searchSM">
            <input id="confirm" type="password" placeholder="Xác Nhận Mật Khẩu" size="5" maxlength="100" class="boxsearchSM"/>
        </div>
        </br>
        <div class="searchSM">
