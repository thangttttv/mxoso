...
<script type="text/javascript">
    ...
    function lastDay(){
        var date = '<?php echo $data['ngay_quay']?>';
        var id = '<?php echo $id;?>';
        var url = "<?=$url->createUrl('ketqua/TimMienTrung'); ?>";
        $.ajax({
            type: "GET",
            url: url,
            global:false,
...
<div class="bg_white m-t-10 shadow">    
    ...
    <div class="Calendar">
        <center>
            <div>
                ...
                <input type="text" class="boxCalendar" value="Xổ số <?php echo $tinh['name'];?>" style="text-align: center;">
            </div>
        </center>
    ...
    <div class="titleXSMB">
        Kết quả sổ xố trực tiếp <?php echo $tinh['name'];?> ngày <span class="red"><?php echo date('d/m/Y',strtotime($data['ngay_quay'])); ?></span>
    </div>
    <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eaeaea">
        <tr class="XSMB_ngang">
            ...
            <td class="XSMB_2" colspan="8">
                <p><a><?php echo $data['giai_dacbiet']; ?></a></p>
            </td>
        </tr>
        <tr class="XSMB_ngang">
        ...
        <tr>
            <td class="XSMB_2" colspan="3">
                <?php echo $data['giai_tu_5']; ?>
            </td>
            <td class="XSMB_2" colspan="2">
                <?php echo $data['giai_tu_6']; ?>
            </td>
            <td class="XSMB_2" colspan="3">
                <?php echo $data['giai_tu_7']; ?>
            </td>
            </td>
        </tr>
        <tr class="XSMB_ngang">
        ...
        <tr class="XSMB_ngang">
            ...
            <td class="XSMB_2 XSMB_ngang_xam" colspan="8">
                <?php echo $data['giai_bay']; ?>
            </td>
        </tr>
        <tr class="XSMB_ngang">
            <td class="XSMB_1">Giải Tám</td>
            <td class="XSMB_2" colspan="8">
                <?php echo $data['giai_tam']; ?>
            </td>
        </tr>
    </table>
    ...
    <?php
        ...
        $daucuoi[2] = $data['giai_nhi'];
        $daucuoi[3] = $data['giai_ba_1'];
        $daucuoi[4] = $data['giai_ba_2'];
        $daucuoi[5] = $data['giai_tu_1'];
        $daucuoi[6] = $data['giai_tu_2'];
        $daucuoi[7] = $data['giai_tu_3'];
        $daucuoi[8] = $data['giai_tu_4'];
        $daucuoi[9] = $data['giai_tu_5'];
        $daucuoi[10] = $data['giai_tu_6'];
        $daucuoi[11] = $data['giai_tu_7'];
        $daucuoi[12] = $data['giai_nam'];
        $daucuoi[13] = $data['giai_sau_1'];
        $daucuoi[14] = $data['giai_sau_2'];
        $daucuoi[15] = $data['giai_sau_3'];
        $daucuoi[16] = $data['giai_bay'];
        $daucuoi[17] = $data['giai_tam'];
        $daucuoi[18] = $data['giai_nhat'];
        //var_dump($daucuoi);
    ?>
