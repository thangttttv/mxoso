...
<div class="bg_white m-t-10 shadow">    
    ...
    <div class="Calendar">
        <center>
            <div>
                <form method="POST" action="<?php echo Yii::app()->createUrl('ketqua/redirectMienTrung');?>">
        ...
        <div class="arrowCalendar_1">
            <a href="<?php echo Yii::app()->createUrl('ketqua/ketquamientrung',array('last'=>date("Y-m-d",strtotime("-7 day",strtotime($data1['ngay_quay'])))));?>"><img src="<?php echo Yii::app()->params['static_url'];?>images/xo-so-10h-icon-arrowlich.png" style="padding-top:14px;"/></a>
        </div>
        <div class="arrowCalendar_2">
            <a href="<?php echo Yii::app()->createUrl('ketqua/ketquamientrung',array('next'=>date("Y-m-d",strtotime("+7 day",strtotime($data1['ngay_quay'])))));?>"><img src="<?php echo Yii::app()->params['static_url'];?>images/xo-so-10h-icon-arrowlich2.png" style="padding-top:14px;"/></a>
        </div>
    </div>
    <div class="titleXSMN">
