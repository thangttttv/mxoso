...
<div class="bg_white m-t-10 shadow">    
    <div class="menuXS m-t-10">
        <ul>
            ...
            <li id="miennam"><a href="<?php echo Yii::app()->createUrl('home/miennam')?>"><h1>XỔ SỐ MIỀN NAM</h1></a></li>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#c9c9c9">
        <tr class="XSMB_ngang_1 XSMB_ngang_xam">
            ...
            <td class="XSMN_2"><span class="red"><?php echo $id4['name'];?></span></td>
        </tr>
        <tr class="XSMN_ngang">
            ...
            <td class="XSMN_2 bg_xam"><?php echo $data4['giai_tam']?></td>
        </tr>
        <tr class="XSMB_ngang">
        ...
        <tr class="XSMN_ngang">
            ...
            <td class="XSMN_2 bg_xam">
                <?php echo $data4['giai_sau_1']?><br />
                <?php echo $data4['giai_sau_2']?><br />
                <?php echo $data4['giai_sau_3']?>
            </td>
        </tr>
        <tr class="XSMB_ngang">
            ...
            <td class="XSMN_2 fon16"><?php echo $data4['giai_nam']?></td>
        </tr>
        <tr class="XSMN_ngang">
            ...
            <td class="XSMN_2 bg_xam">
                <?php echo $data4['giai_tu_1']?><br />
                <?php echo $data4['giai_tu_2']?><br />
                <?php echo $data4['giai_tu_3']?><br />
                <?php echo $data4['giai_tu_4']?><br />
                <?php echo $data4['giai_tu_5']?><br />
                <?php echo $data4['giai_tu_6']?><br />
                <?php echo $data4['giai_tu_7']?>
            </td>
        </tr>
        <tr class="XSMB_ngang">
            ...
            <td class="XSMN_2 fon16">
                <?php echo $data4['giai_ba_1']?><br />
                <?php echo $data4['giai_ba_2']?>
            </td>
        </tr>
        <tr class="XSMN_ngang">
            ...
            <td class="XSMN_2 bg_xam"><?php echo $data4['giai_nhi']?></td>
        </tr>
        <tr class="XSMB_ngang">
            ...
            <td class="XSMN_2 fon16"><?php echo $data4['giai_nhat']?></td>
        </tr>
        <tr class="XSMN_ngang">
            ...
            <td class="XSMN_2 bg_xam"><strong class="red"><?php echo $data4['giai_dacbiet']?></strong></td>
        </tr>
    </table>
    <div class="LOTOTT">
    ...
    <?php
        ...
        $arr_data4[1]= $data4['giai_dacbiet'];
        $arr_data4[2]= $data4['giai_nhat'];
        $arr_data4[3]= $data4['giai_nhi'];
        $arr_data4[4]= $data4['giai_ba_1'];
        $arr_data4[5]= $data4['giai_ba_2'];
        $arr_data4[6]= $data4['giai_tu_1'];
        $arr_data4[7]= $data4['giai_tu_2'];
        $arr_data4[8]= $data4['giai_tu_3'];
        $arr_data4[9]= $data4['giai_tu_4'];
        $arr_data4[10]= $data4['giai_tu_5'];
        $arr_data4[11]= $data4['giai_tu_6'];
        $arr_data4[12]= $data4['giai_tu_7'];
        $arr_data4[13]= $data4['giai_nam'];
        $arr_data4[14]= $data4['giai_sau_1'];
        $arr_data4[15]= $data4['giai_sau_2'];
        $arr_data4[16]= $data4['giai_sau_3'];
        $arr_data4[17]= $data4['giai_bay'];
        $arr_data4[18]= $data4['giai_tam'];
    ?>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#eaeaea">
        ...
        <tr class="LOTO_ngang_1">
            ...
            <td class="LOTO_2 XSMB_ngang_xam">
                <?php
                    for($i=1;$i<=count($arr_data4);$i++)
                    {
                        if(substr($arr_data4[$i],-2,1)==0)
                        {
                            echo substr($arr_data4[$i],-1,1)." ";
                        }
                    }
                ?>
            </td>
